        ...
        if ($_GET['tabla'] == 'bienvenido' || $_GET['tabla'] == null) {
            ...
            if (!str_contains($tabla, '_has_')) {
                foreach ($tablaResul as $row) {
                    ...
                    echo '<td> <a href="../db/delete.php?id=' . $row['id'] . '&tabla=' . $tabla . '"><i class="fas fa-trash"></i></a>';
                    echo '<a href="update.php?id=' . $row['id'] . '&tabla=' . $tabla . '"><i class="fas fa-pen"></i></a></td>';
                    echo "</tr>";
                }
            } else {
                ...
                foreach ($tablaResul as $row) {
                    ...
                    echo '<td> <a href="../db/delete.php?' . $nameColumns[0][0] . '=' . $row[0] . '&' . $nameColumns[1][0] . '=' . $row[1]
                        . '&tabla=' . $tabla . '&idUno=' . $nameColumns[0][0] . '&idDos=' . $nameColumns[1][0] . '"><i class="fas fa-trash"></i></a></td>';
                    echo "</tr>";
                }
                echo '</tbody>
            </table>';
