...
<head>
    ...
    <link rel="stylesheet" href="../style/styleLibroJaneEyre.css">
...
<body>
    ...
    <div>
        <main>
            <section id="main">
                <div id="foto">
                    <img src="../img/janeEyre.png" width="300px" height="350px">             
                </div>
                <div id="titulo">
                    <h1>JANE EYRE, Charlotte Brontë</h1>                 
                </div>
                <div id="sinopsis">
                    <p>Dueña de un singular temperamento desde su complicada infancia de huérfana, primero 
                        a cargo de una tía poco cariñosa y después en la escuela Lowood, Jane Eyre logra el 
