...
<head>
    ...
    <link rel="stylesheet" href="../style/styleContacto.css?ver=1.3">
    ...
    <div class="mainNaside">
        <main>
            ...
            <section class="formulario">
                <form>
                    ...
                    <br><br>
                    <label id="checkmark"><input type="checkbox">
                        <p>¿Desea recibir información relevante a su correo?</p>
                    </label>
                    <br><br>
        ...
        <aside>
            ...
            <article class="noticias">
                <h5>
                    <a href="https://www.planetadelibros.com/blog/actualidad/15/actualidad-premios/15/articulo/luz-gabas-premio-planeta-2022-y-cristina-campos-finalista/501">Ganadora
