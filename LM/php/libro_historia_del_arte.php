...
<body>
    ...
    <div>
        <main>
            <section id="main">
                <div id="foto">
                    <img id="imagen" src="../img/historia_del_arte.png">
                </div>
                <div id="texto">
                    <div id="titulo">
                    ...
                    <div id="sinopsis">
                        <p>Es uno de los libros dedicados al arte más famosos y populares nunca escritos y ha sido
                            un best-seller durante medio siglo. Durante cinco décadas no ha tenido ningún rival como
                            introducción al arte en su totalidad, abarcando desde las pinturas rupestres primitivas
                            hasta el arte experimental contemporáneo.</p>
                        <p>Si quieres ver un resumen de la historia del arte rápido y entretenido, visualiza este
                            <a href="https://www.youtube.com/watch?v=rUHxLrZwSIY">Video</a>
                        </p>
                        <p>Añade a tu lista:</p><?php
